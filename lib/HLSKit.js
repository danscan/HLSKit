...
var HLSKit = {
  ...
  /**
   * playlistSessionFromObject
   * returns an instance of PlaylistSession with pre-existing
   */
  playlistSessionFromObject: function playlistSessionFromObject(object) {
    var playlistSession;
 ...
 */
PlaylistSession.prototype.serialize = function () {};
